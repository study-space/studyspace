...
public class DummyDataInitializer {
    ...
    public void addDummyData() {
        ...
        placeService.savePlace(
                new Place("토즈 방이", new Location(37.516962, 127.112372), "070-4987-7998", "서울특별시 송파구 방이2동 44", "http://toz.com")
        );

        placeService.savePlace(
                new Place("노량진스터디룸", new Location(37.5128395, 126.9451906), "070-4670-7949", "서울특별시 동작구 노량진동", null)
        );
